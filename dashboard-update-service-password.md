...
![Update password job running](./images/mysql-update-password-running.png "The Deployment Details pane, showing one running job: Change Mysql password running")
