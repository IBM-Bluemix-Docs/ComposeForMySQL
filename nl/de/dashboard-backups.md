...
![Sicherungen](./images/mysql-backups-show.png "Liste der verfügbaren Sicherungen")

Klicken Sie in eine Zeile, um die Optionen für die entsprechende verfügbare Sicherung zu erweitern.

![Sicherungsoptionen](./images/mysql-backups-options.png "Optionen für eine Sicherung.") 
...
Die Wiederherstellung einer älteren Version eines {{site.data.keyword.composeForMySQL}}-Service auf einem neuen Service unter Ausführung von MySQL 5.7.20 sieht wie folgt aus: 
```
