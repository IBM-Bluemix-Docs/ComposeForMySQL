...
Utilice los pasos siguientes para restaurar una copia de seguridad de un servicio MySQL en ejecución a un servicio MySQL nuevo mediante la CLI de {{site.data.keyword.cloud_notm}}. 
...
Por ejemplo, la restauración de una versión anterior de un servicio {{site.data.keyword.composeForMySQL}} a un servicio nuevo que ejecute MySQL 5.7.20 tendrá este aspecto:
```
