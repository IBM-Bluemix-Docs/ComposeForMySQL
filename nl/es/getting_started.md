...
Esta guía de aprendizaje utiliza la app de ejemplo [compose-mysql-helloworld-nodejs](https://github.com/IBM-Cloud/compose-mysql-helloworld-nodejs) para demostrar cómo utilizar Node.js para conectarse a un servicio de {{site.data.keyword.composeForMySQL_full}} utilizando las credenciales proporcionadas. La aplicación crea, lee y escribe en una base de datos utilizando datos suministrados a través de la interfaz web de la app.
{: shortdesc}
...
Antes de enviar la app en {{site.data.keyword.cloud_notm}}, puede ejecutarla localmente para probar la conexión a su instancia de servicio de {{site.data.keyword.composeForMySQL}}. Para conectarse al servicio deberá crear un conjunto de credenciales de servicio.
...
## Paso 10: Comprobar que la app está conectada al servicio de {{site.data.keyword.composeForMySQL}}
