...
## Passo 1: crea un'istanza del servizio {{site.data.keyword.composeForMySQL}}
{: #create-service}
...
4. Aggiorna il valore `services` in modo che corrisponda al nome del servizio che hai creato in [Crea un'istanza del servizio {{site.data.keyword.composeForMySQL}}](#create-service). 
