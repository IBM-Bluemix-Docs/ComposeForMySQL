...
Este tutorial usa o app de amostra [compose-mysql-helloworld-nodejs](https://github.com/IBM-Cloud/compose-mysql-helloworld-nodejs) para demonstrar como conectar um aplicativo a um serviço {{site.data.keyword.composeForMySQL_full}}. O aplicativo cria, lê e grava em um banco de dados utilizando os dados fornecidos por meio da interface da web do app.
{: shortdesc}
...
Essa etapa falhará se o serviço não tiver concluído o fornecimento da Etapa 1. É possível verificar o progresso do fornecimento para se certificar de que tenha sido concluído, acessando a visualização _Gerenciar_ do serviço.
{: .tip}
...
## Etapa 8: Verificar se o app está conectado ao serviço {{site.data.keyword.composeForMySQL}}
...
Em vez de enviar o app por push para o {{site.data.keyword.cloud_notm}}, é possível executá-lo localmente para testar a conexão com a instância de serviço do {{site.data.keyword.composeForMySQL}}. Para se conectar ao serviço será necessário criar um conjunto de credenciais de serviço.
...
6. No editor de sua preferência, crie um novo arquivo com o seguinte, substituindo o texto 'INSERIR SUAS CREDENCIAIS AQUI' pelo conteúdo completo das credenciais copiadas na etapa anterior:
